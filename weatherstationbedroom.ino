...
int sliderLEDbrightness = 100; 
int sliderRGBbrightness = 100;
...
BLYNK_WRITE(V17)
{
    sliderRGBbrightness = param.asInt();
        ...
        else
        {
            ...
            LEDbrightness = ((analogRead(A0) * 0.0005) * sliderLEDbrightness) + 1;
...
//	dht.begin();
  ...
  output = "\nBSEC library version " + String(iaqSensor.version.major) + "." + String(iaqSensor.version.minor) + "." + String(iaqSensor.version.major_bugfix) + "." + String(iaqSensor.version.minor_bugfix);
                //terminal.clear();
				terminal.println("----------------------------------");
				terminal.println("STARTING BEDROOM BLYNK SERVER v1.1");
